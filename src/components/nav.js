...
export default function Navbar() {
    ...
    return (
        <header className="fixed top-0 lg:px-48 px-3 flex flex-wrap items-center shadow-lg text-white py-4 w-full" style={{ backgroundColor: "#621CC8" }}>
            ...
            <button onClick={() => setNavbarOpen(!navbarOpen)} type="button" className="text-gray-300 focus:text-white focus:outline-none hover:text-white lg:hidden block pr-10">
